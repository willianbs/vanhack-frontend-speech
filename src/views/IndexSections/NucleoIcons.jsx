      ...
      <div className="section section-nucleo-icons">
        ...
        <Container>
          <Row className="justify-content-center">
            <Col lg="8" md="12">
              ...
              <h4 className="description">
                styles• Design System PRO comes with 100 custom icons made by our
                friends from NucleoApp. The official package contains over 2.100
                thin icons which are looking great in combination with styles•
              ...
              <div className="btn-wrapper">
                <Button
                  className="btn-round"
                  color="primary"
                  href="https://demos.creative-tim.com/styles-design-system-react/#/documentation/icons"
          ...
          <div className="blur-hover">
            <a href="https://demos.creative-tim.com/styles-design-system-react/#/documentation/icons">
